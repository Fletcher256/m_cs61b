...
public class LinkedListDeque61BTest {
    ...
    @Test
    public void TestRecursiveNull() {
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();

        assertThat(lld1.getRecursive(0)).isEqualTo(null);
        assertThat(lld1.getRecursive(-232)).isEqualTo(null);
        assertThat(lld1.getRecursive(6578)).isEqualTo(null);

    }

    @Test
    public void TestRecursivetNormal() {
        Deque61B<Integer> lld1 = new LinkedListDeque61B<>();
        ...
        assertThat(lld1.getRecursive(5)).isEqualTo(90);
    }
}