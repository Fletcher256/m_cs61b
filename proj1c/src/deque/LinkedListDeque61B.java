...
public class LinkedListDeque61B<T> implements Deque61B<T>{
    private class ListDeque61BIterator implements Iterator<T>
    {
        private int index = 0;
    ...
    public Iterator iterator() {
        return new ListDeque61BIterator();
    }
    ...
    * */
    ...
    public boolean equals(Object o)
    {
        ...
        {
            if(((LinkedListDeque61B)o).size() == size)
            {
                Node ThisCurrent = sentinel;

                for(int i = 0; ThisCurrent.next.data != null; i++)
                {
                    if((ThisCurrent = ThisCurrent.next).data != ((LinkedListDeque61B)o).get(i))
                    {
                        return false;
                    }
                }
